        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-5 flex-col">
            ...
            <div className="flex flex-col items-center justify-center p-4">
              {" "}
              <h1 className="text-3xl md:text-5xl font-bold text-slate-200 font-serif">
                  {" "}
                  Please Contact{" "}
                </h1>{" "}
              <div className="text-center mb-8 shadow-lg p-4">
                {" "}
                <p className="text-sm text-white">
                  {" "}
                  FOR ANY QUERIES AND MORE INFORMATION{" "}
                </p>{" "}
              ...
              <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4">
                {" "}
                <button
                  onClick={() => setActiveDiv("chairman")}
                  className="px-6 py-2 border border-gray-300 text-white bg-yellow-600 hover:bg-yellow-800 transition duration-200 rounded-sm shadow-lg"
                >
                  {" "}
                  Chairman{" "}
                </button>{" "}
                <button
                  onClick={() => setActiveDiv("vicechairman")}
                  className="px-6 py-2 border border-gray-300 text-white bg-blue-600 hover:bg-blue-800 transition duration-200 rounded-sm shadow-lg"
                >
                  {" "}
                  Vice-Chairman{" "}
                </button>{" "}
                <button
                  onClick={() => setActiveDiv("accounts&financehead")}
                  className="px-6 py-2 border border-gray-300 text-white bg-green-600 hover:bg-green-800 transition duration-200 rounded-sm shadow-lg"
                >
                  {" "}
              ...
              {activeDiv === "chairman" && (
                <div className="mt-8 border-2 border-dashed border-yellow-500 p-6 w-full md:w-96 bg-white rounded-xl shadow-lg transition-all">
                  {" "}
                  <h2 className="text-xl font-bold text-gray-800">
                    NAMAN KEMANI
                  </h2>{" "}
                  <p className="flex items-center mt-2 text-gray-600 ml-2">
                    {" "}
                    <FaEnvelope className="mr-2" /> namankemani@gmail.com{" "}
                  </p>{" "}
                  <p className="flex items-center mt-2 text-gray-600 ml-2">
                    {" "}
                    <FaPhone className="mr-2" /> 7017834526{" "}
                  </p>{" "}
                </div>
              )}{" "}
              {activeDiv === "vicechairman" && (
                <div className="mt-8 border-2 border-dashed border-blue-500 p-6 w-full md:w-96 bg-white rounded-xl shadow-lg transition-all">
                  {" "}
                  <h2 className="text-xl font-bold text-gray-800">
                    DEVESH VAID
                  </h2>{" "}
                  <p className="flex items-center mt-2 text-gray-600 ml-2">
                    {" "}
                    <FaEnvelope className="mr-2" /> deveshvaid40@gmail.com{" "}
                  </p>{" "}
                  <p className="flex items-center mt-2 text-gray-600 ml-2">
                    {" "}
                    <FaPhone className="mr-2" /> 7818995902{" "}
                  </p>{" "}
                </div>
              )}{" "}
              {activeDiv === "accounts&financehead" && (
                <div className="mt-8 border-2 border-dashed border-green-500 p-6 w-full md:w-96 bg-white rounded-xl shadow-lg transition-all">
                  {" "}
                  <h2 className="text-xl font-bold text-gray-800">
                    SHIVANSH PANT
                  </h2>{" "}
                  <p className="flex items-center mt-2 text-gray-600 ml-2">
                    {" "}
                    <FaEnvelope className="mr-2" /> pantshivansh09@gmail.com{" "}
                  </p>{" "}
                  <p className="flex items-center mt-2 text-gray-600 ml-2">
                    {" "}
                    <FaPhone className="mr-2" /> 6398625427{" "}
                  </p>{" "}
                </div>
              )}{" "}
            </div>{" "}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between pb-14 border-b border-gray-500 gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.instagram.com/colosseum4cot/#"
