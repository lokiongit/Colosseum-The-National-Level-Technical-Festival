  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col sm:flex-row items-center justify-between pb-14 border-b border-gray-500 gap-8">
        <a href="#" className="">
  <img src="https://hosting.renderforestsites.com/27275532/1337287/media/4441c38e76395561da703f3c11e8f267.webp" alt="" className='w-28 h-28' />
        ...
        <div className="flex items-center gap-4">
          <a href="javascript:;"
            ...
            <svg xmlns={Image} width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path
      ...
      <div className="py-14 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-500">
        <div className="w-full max-lg:mx-auto flex flex-col sm:flex-row max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-24">
          ...
          <div className="">
            <h6 className="text-lg font-medium text-white mb-7 max-lg:text-center">Events</h6>
            <ul className="flex flex-col gap-6 max-lg:items-center ">
              <li><a href="javascript:;"
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 hover:underline">Corrobore</a></li>
              <li><a href="javascript:;"
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 hover:underline">Panga</a></li>
              <li><a href="javascript:;"
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 hover:underline">Dj Night</a></li>
              <li><a href="javascript:;"
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 hover:underline">Colosseum'25</a></li>
            </ul>
          </div>
          <div className="">
            ...
            <ul className="flex flex-col gap-6 max-lg:items-center">
              <li><a href="javascript:;"
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 hover:underline">FAQs</a>
              </li>
              <li><a href="javascript:;"
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 hover:underline">Contact Us</a></li>
              <li><a href="javascript:;"
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 hover:underline">Sign In</a>
              </li>
              <li><a href="javascript:;"
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400 hover:underline">Sign out</a></li>
            </ul>
          </div>
        </div>
        <div className="w-full lg:max-w-md max-lg:mx-auto ">
          <h6 className="text-lg font-medium text-white mb-7">Connect With Us</h6>
            ...
            <form action="#" className="flex flex-col gap-5">
              <div className="relative">
                ...
                <input type="text" id="default-search"
                  ...
                  placeholder="colo4cot@gmail.com" required="" />
              </div>
      ...
      <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
        ...
        <a href="#" className="">©Colosseum</a> 2025, All rights reserved.
        </span>
